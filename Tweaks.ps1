...
#
#     > powershell -nop -c "iex(New-Object Net.WebClient).DownloadString('https://git.io/JkZwQ')"
#
#	Tech Additions:
#
#	- Dark Mode
...
Function InstallandRunOandO {
	Write-Output "Running O&O Shutup with Recommended Settings"
	Import-Module BitsTransfer
	Start-BitsTransfer -Source "https://raw.githubusercontent.com/TutsGhost/win10script/master/ooshutup10.cfg" -Destination ooshutup10.cfg
...
# Download and execute the Installer-Menu
Function CallInstallerMenu {
    iex(New-Object Net.WebClient).DownloadString('https://git.io/JOMdC')
    }
...
do
 {
    Clear-Host
    Write-Host "================ System adjustments ================"
    Write-Host "1: Press '1' to only run the Tweaks."
    Write-Host "2: Press '2' to only run the Installer Menu."
    Write-Host "3: Press '3' to run both the Tweaks and the Installer Menu."
 ...
 until ($selection -match "1" -or $selection -match "2" -or $selection -match "3" -or $selection -match "q")